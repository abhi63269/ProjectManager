		...
		<div  class="col-sm-12" >
			<div class="jumbotron"  style="background-color:white; color:black;padding:25px;">
				...
				<div class="row">
					...
					<div id=jumbotask class="col-sm-8" style="padding-left:35px;" >
					...
					<div id=insidetask class="col-sm-8" style="display:none" >
						<h3>Task 1</h3>
						<hr align="left">
						<form>
						<div class="row" style="font-size:125%;padding-left:25px;">
							...
							<div class="form-group">
									...
									Description
      								...
      								<label for="disabledTextInput" class="col-sm-10 control-label" style="font-weight: normal;">
       									   sakjsdkasjkdsjkajdkjaskjfd dfjkhdfshgdsh dfjkghdsgh fdjkghdfjkghd dfsgbdfhgbdf dfhgdfhjb dfghdfghdfg fjdfghjdsf fjdfghjdsf fjdfghjdsf fjdfghjdsf fjdfghjdsf fjdfghjdsf fjdfghjdsf fjdfghjdsf fjdfghjdsf fjdfghjdsf fjdfghjdsf fjdfghjdsf 
        								</label>
      							</div><br><br><br><br>
							<div class="form-group">
      				 				 <label for="disabledTextInput" class="col-sm-2 control-label">
							...
							<div class="btn pull-right">
								<input type="submit" style="background-color:red;width:100px;padding:7px;color:white;" align="right"  value="Save">
							</div>
						</form>
					</div>
				</div>
...
$("tr").click(function table(){
		...
		//document.getElementById("insidetask").style.display="block";
                Id =$(this).attr('id');
                var broid=Id;
                var url = "SubTaskDescHttpServlet?broid="+broid;
